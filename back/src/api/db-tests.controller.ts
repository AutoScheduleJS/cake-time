...
export const controller = _ => (_req: Request, res: Response, _next) => {
  ...
  CREATE (pateBriseeDir2)-[:INSTRUCTION {ans:'x', quantity:1}]->(versezXsurY)
